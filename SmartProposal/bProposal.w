...
&Scoped-define FIELDS-IN-QUERY-br_table PROPSL# CUST# C-NAME L-NAME 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br_table bTable _STRUCTURED
  QUERY br_table NO-LOCK DISPLAY
      PROPSL# FORMAT "ZZZZZZZZZZ":U
      CUST# FORMAT "ZZZZZZZZZZ":U
      C-NAME FORMAT "X(25)":U
      L-NAME FORMAT "X(25)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br_table
     ...
     _FldNameList[1]   = _<SDO>.rowObject.PROPSL#
     _FldNameList[2]   = _<SDO>.rowObject.CUST#
     _FldNameList[3]   = _<SDO>.rowObject.C-NAME
     _FldNameList[4]   = _<SDO>.rowObject.L-NAME
